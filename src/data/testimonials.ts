...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: "t1",
    clientName: "Hendra Kusuma",
    roleOrProject: "Pemilik Residensi Senopati",
  ...
  {
    id: "t2",
    clientName: "dr. Amanda Putri",
    roleOrProject: "Owner Klinik Estetika Menteng",
  ...
  {
    id: "t3",
    clientName: "Pratama Wijaya",
    roleOrProject: "Pemilik Tech Hub SCBD",
    location: "Jakarta Selatan",
    quote:
  ...
  {
    id: "t4",
    clientName: "Ratna Sastro",
    roleOrProject: "Pemilik Sanctuary Villa Ubud",
    location: "Ubud, Bali",
    quote:
